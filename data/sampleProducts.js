...
export const sampleProducts = [
  ...
  {
    barcode: "8690504008118",
    name: "Biskrem Kakaolu",
    brand: "Ülker",
    category: "Gıda / Atıştırmalık",
    imageUrl: null,
    ethicInfo: {
    ...
    ethicScore: 35,
    description: "İçeriğinde palm yağı ve hayvansal ürünler (süt tozu) bulunmaktadır.",
    alternatives: ["8691234000010"],
  },
  {
    barcode: "8690624200675",
    name: "Didi Soğuk Çay Şeftali",
    brand: "Çaykur",
    category: "Gıda / İçecek",
    imageUrl: null,
    ethicInfo: {
    ...
    ethicScore: 85,
    description: "Yerel üretim Çaykur çaylarından elde edilir, vegan ve sürdürülebilirdir.",
    alternatives: [],
  },
];
